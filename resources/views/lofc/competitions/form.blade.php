...
<div class="container">
  <ol class="breadcrumb">
    ...
    <li>Añadir competición</li>
  </ol>
  <div class="page-header">
    <h1 class="premier" style="font-size: 32px;margin-left: 313px; margin-bottom: -46px">´</h1>
    <h1 class="premier">Nueva competicion de la temporada {{$season_id}}</h1>
  </div>
  <div class="row">
    <div class="col-md-3"></div>
    <div class="col-md-6 form-group">
      {!! Form::open(array('url' => 'lofc/competitions/save/'.$season_id)) !!}
